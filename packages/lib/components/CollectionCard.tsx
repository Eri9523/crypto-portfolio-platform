...
export const CollectionCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="aspect-[16/9] w-full bg-gray-600 relative overflow-hidden rounded-t-lg">
        {collection.banner ? (
          <img
      ...
      <div className="p-4 flex flex-col gap-1 min-h-0">
        <div
          ...
          <span className="text-gray-100 text-xs font-mono">
            {shortenAddress(collection.tokenAddress)}
          </span>
          <span className="text-gray-100 text-sm">{collection.symbol}</span>
        </div>
